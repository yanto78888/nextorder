...
async function markOrderQrisPaid(trxid) {
  ...
  try {
    ...
    if (user && product) {
      ...
      // Komisi referral -- sama kayak checkout saldo, diproses PER-ORDER (bukan digabung jadi
      // satu angka). Cuma order yang udah PASTI 'completed' di titik ini aja. Order yang masih
      // 'processing' (Digiflazz/IndoSMM) baru dikreditkan belakangan pas beneran selesai --
