...
async function markOrderQrisPaid(trxid) {
  ...
  try {
    ...
    if (user && product) {
      ...
      // Komisi referral -- sama kayak checkout saldo, dihitung dari order yang udah PASTI
      // 'completed' di titik ini aja. Order yang masih 'processing' (Digiflazz/IndoSMM) baru
