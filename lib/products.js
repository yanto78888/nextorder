...
export function createProduct({ name, category, description, price, stockNote, thumbnail, stockItems, gamePreset, customTargetFields, provider, digiflazzSku, digiflazzCustomerNoTemplate, variantGroup, digiflazzBasePrice, indosmmServiceId, indosmmRatePer1000, indosmmMin, indosmmMax, otpServiceCode, otpServiceName, otpCountryId, otpCountryName, otpBaseCostRub, marginType, marginValue, costPrice, usageInstructions }) {
