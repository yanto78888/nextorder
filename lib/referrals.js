...
// persentase SAMA RATA buat semua jenis transaksi (gak dibedain lagi per jenis produk kayak versi
// sebelumnya), bisa diatur admin lewat halaman Pengaturan (config.referral.percent, lihat
// views/admin/settings.ejs bagian "Komisi Referral"). Default kalau belum pernah diatur: 1%.
// =====================================================================
...
export function creditReferralCommission({ buyer, orderTotal, orderId }) {
  ...
  const commission = (rawCommission <= 0 && total > 0 && percent > 0) ? 1 : rawCommission;
