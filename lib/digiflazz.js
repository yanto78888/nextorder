...
// Cari produk dari price list Digiflazz by keyword (nama produk / brand / sku), dipakai admin buat pilih SKU.
export async function searchPriceList(keyword = '', cmd = 'prepaid') {
...
// Kalau tidak diisi admin, default gabungkan semua value pakai titik (konvensi paling umum dipakai reseller Digiflazz).
